...
public class PhysicsLangParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'mru'", "'funcion'", "'variable'", "'mostrar'", "'for'", 
		"'entero'", "'+'", "'-'", "'*'", "'/'", "'^'", "'&&'", "'||'", "'!'", 
		"'>'", "'<'", "'>='", "'<='", "'=='", "'!='", "'='", "'{'", "'}'", "'('", 
		"')'", "';'", "ID", "ENTERO", "WS"
	};
	...
	public final FuncionContext funcion() throws RecognitionException {
		...
		try {
			...
			{
			setState(16); match(FUNCION);
			setState(17); match(ID);
			setState(18); match(LLAVE_OPEN);
			setState(22);
	...
	public final SentenceContext sentence() throws RecognitionException {
		...
		try {
			...
			case ENTERO_DECL:
				enterOuterAlt(_localctx, 1);
				{
				setState(27); variable_declativa();
				}
				break;
			case ID:
				enterOuterAlt(_localctx, 2);
				{
				setState(28); variable_asignacion();
				}
				break;
			case MOSTRAR:
	...
	public final Variable_declativaContext variable_declativa() throws RecognitionException {
		...
		try {
			...
			consume();
			setState(33); ((Variable_declativaContext)_localctx).ID = match(ID);
			setState(34); match(FIN);
	...
	public final Variable_asignacionContext variable_asignacion() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(37); ((Variable_asignacionContext)_localctx).ID = match(ID);
			setState(38); match(ASIGNAR);
			setState(39); ((Variable_asignacionContext)_localctx).exprecion = exprecion();
			setState(40); match(FIN);
	...
	public final MostrarContext mostrar() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(43); match(MOSTRAR);
			setState(44); ((MostrarContext)_localctx).exprecion = exprecion();
			setState(45); match(FIN);
	...
	public final ExprecionContext exprecion() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(48); ((ExprecionContext)_localctx).t1 = jerarOPE();
			...
			while (_la==SUMA || _la==MENOS) {
				...
				case SUMA:
					{
					setState(50); match(SUMA);
					setState(51); ((ExprecionContext)_localctx).t2 = jerarOPE();
					((ExprecionContext)_localctx).value = (int)_localctx.value +(int)((ExprecionContext)_localctx).t2.value;
					}
					break;
				case MENOS:
					{
					setState(54); match(MENOS);
					setState(55); ((ExprecionContext)_localctx).t2 = jerarOPE();
					((ExprecionContext)_localctx).value = (int)_localctx.value -(int)((ExprecionContext)_localctx).t2.value;
					}
					break;
				default:
	...
	public final JerarOPEContext jerarOPE() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(63); ((JerarOPEContext)_localctx).t1 = termino();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << MULTIPLICACION) | (1L << DIVICION) | (1L << POTENCIA))) != 0)) {
				...
				case MULTIPLICACION:
					{
					setState(65); match(MULTIPLICACION);
					setState(66); ((JerarOPEContext)_localctx).t2 = termino();
					((JerarOPEContext)_localctx).value = (int)_localctx.value *(int)((JerarOPEContext)_localctx).t2.value;
					}
					break;
				case DIVICION:
					{
					setState(69); match(DIVICION);
					setState(70); ((JerarOPEContext)_localctx).t2 = termino();
					((JerarOPEContext)_localctx).value = (int)_localctx.value /(int)((JerarOPEContext)_localctx).t2.value;
					}
					break;
				case POTENCIA:
					{
					setState(73); match(POTENCIA);
					setState(74); ((JerarOPEContext)_localctx).t2 = termino();
	...
	public final TerminoContext termino() throws RecognitionException {
		...
		try {
			...
			case ENTERO:
				enterOuterAlt(_localctx, 1);
				{
				setState(82); ((TerminoContext)_localctx).ENTERO = match(ENTERO);
			...
			case ID:
				enterOuterAlt(_localctx, 2);
				{
				setState(84); ((TerminoContext)_localctx).ID = match(ID);
			...
			case PAR_OPEN:
				enterOuterAlt(_localctx, 3);
				{
				setState(86); match(PAR_OPEN);
				setState(87); ((TerminoContext)_localctx).exprecion = exprecion();
				((TerminoContext)_localctx).value =  ((TerminoContext)_localctx).exprecion.value;
				setState(89); match(PAR_CLOSE);
				}
				break;
			default:
				throw new NoViableAltException(this);
